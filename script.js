...
// Constants
const noiseRepository = 'https://raw.githubusercontent.com/amiashanley/HNF/main/map_noise_files_01/';
const denoiseRepository = 'https://raw.githubusercontent.com/amiashanley/HNF/main/map_denoise_files_01/';
const jsonDataUrl = 'https://raw.githubusercontent.com/amiashanley/HNF/main/HNF_pop-up_data_file_03.json';
...
function showPopup() {
    ...
    <div class="page" id="page-5" style="display: none;">
        <p>Through the frameworks of critical data studies and extractivism, HNF aims to situate the noise floor as a highly localised, non-neutral, audible ecological material. Here, the noise floor is explored as both an archive of the in-situ acoustic properties of the rooms and places where these recordings were made and as a cartography of the geosocial conditions and curatorial decisions that (in)directly produced the Her Noise (2005) exhibition.</p>
        <br>
        <p>HNF asks, what does the presence of an audible noise floor in these archived recordings tell us about the social dynamics, economic conditions, climate, and geopolitical context in which the Her Noise (2005) exhibition originated?</p>
